...
{
	public class PatternStringSearchResponse
	{
		public PatternStringSearchResponse()
		{
			MatchList = new List<PatternStringSearchMatch>(0);
		}
		...
		public List<PatternStringSearchMatch> MatchList
		{
			get;
			set;
		}
